"""
Demo: Sentence Transformers 基本使用
展示如何載入 embedding model 並取得文字的向量特徵

功能：
- 載入預訓練的 embedding model (all-MiniLM-L6-v2)
- 將文字轉換為向量特徵 (384 維)
- 輸出向量形狀和部分數值
"""
...
print(f"第二句的前 5 個特徵值: {embeddings[1][:5]}")

# 執行結果
# 向量形狀 (embeddings.shape): (2, 384)
# 第一句的前 5 個特徵值: [0.03097137 0.09432378 0.04806018 0.02745436 0.02937624]